### This file is originally copied from https://github.com/debianmaster/openshift-examples/tree/master/promethus along side with prom-configmap.yml and grafana-dashboard.json files
